...
export class BooksController {
    ...
    async createBook(@Body() dto: CreateBookDto, @currentUser() currentUser): Promise<BookEntity> {   
    ...
    @ApiOkResponse({ type: ResponseBookDto })
    async updateBookInfo(@Param('id') id:string, @Body() dto: UpdateBookDto): Promise<BookEntity> {
